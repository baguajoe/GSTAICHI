...
// Organized video data by category
const videoCategories = {
    ...
    smallFrame: [
        { 
            src: 'https://player.vimeo.com/video/720756335?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479', 
            title: "15 Techniques Small Solo Frame",
            description: ""
        },
        { 
            src: 'https://player.vimeo.com/video/1120307509?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479', 
            title: "Small Circle 21 Techniques",
            description: "Advanced small circle movements focusing on compact, efficient techniques."
        },
        { 
            src: 'https://player.vimeo.com/video/1120306098?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479', 
            title: "Small Circle 34 Techniques",
            description: "Comprehensive small circle form with expanded techniques and applications."
        }
    ],
    mediumFrame: [
        {
    ...
    specialForms: [
        { 
            src: 'https://player.vimeo.com/video/608292802?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479', 
            title: "12 Techniques Returning Tai Chi Chuan Solo Form",
            description: ""
        },
        {
    ...
    return (
        <div>
            ...
            <div className="container-fluid px-4 py-4">
                ...
                {/* Beginners Section */}
                <h2 className="mb-4 mt-4">Beginner Forms</h2>
                <div className="row g-4">
                    {videoCategories.beginners.map((video, index) => (
                        <div key={`beginner-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>

                {/* Small Frame Section */}
                <h2 className="mb-4 mt-5">Small Frame Forms</h2>
                <div className="row g-4">
                    {videoCategories.smallFrame.map((video, index) => (
                        <div key={`small-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>

                {/* Medium Frame Section */}
                <h2 className="mb-4 mt-5">Medium Frame Forms</h2>
                <div className="row g-4">
                    {videoCategories.mediumFrame.map((video, index) => (
                        <div key={`medium-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>
                ...
                {/* Large Frame Section */}
                <h2 className="mb-4 mt-5">Large Frame Forms</h2>
                <div className="row g-4">
                    {videoCategories.largeFrame.map((video, index) => (
                        <div key={`large-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>
                ...
                {/* Weapons Section */}
                <h2 className="mb-4 mt-5">Weapons</h2>
                <div className="row g-4">
                    {videoCategories.weapons.map((video, index) => (
                        <div key={`weapons-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>
                ...
                {/* Qigong Section */}
                <h2 className="mb-4 mt-5">Qigong & Standing Exercises</h2>
                <div className="row g-4">
                    {videoCategories.qigong.map((video, index) => (
                        <div key={`qigong-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>

                {/* Partner Drills Section */}
                <h2 className="mb-4 mt-5">Partner Training</h2>
                <div className="row g-4">
                    {videoCategories.partnerDrills.map((video, index) => (
                        <div key={`partner-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>
                ...
                <h2 className="mb-4 mt-5">Special & Traditional Forms</h2>
                <div className="row g-4">
                    {videoCategories.specialForms.map((video, index) => (
                        <div key={`special-${index}`} className="col-12 col-md-6 col-lg-4">
                            <VideoComponent src={video.src} description={video.description} title={video.title} />
                        </div>
                    ))}
                </div>
